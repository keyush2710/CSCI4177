...
* *Lab URL*: <https://main--cute-alfajores-a24d1e.netlify.app/>
* *Git tutorial 2 URL*: <https://git.cs.dal.ca/keyush/csci4177_5709_tutorials/-/tree/main/Tutorial2?ref_type=heads>
* *Git Group Project url*: <https://git.cs.dal.ca/ngaikwad/csci-4177-grp-16>
* *Git keyush branch url*: <https://git.cs.dal.ca/ngaikwad/csci-4177-grp-16/-/tree/keyush?ref_type=heads>
* *Git Devon branch url*: <https://git.cs.dal.ca/ngaikwad/csci-4177-grp-16/-/tree/Devon?ref_type=heads>
* *Git Nupur branch url*: <https://git.cs.dal.ca/ngaikwad/csci-4177-grp-16/-/tree/Nupur?ref_type=heads>
* *Git Ahmed branch url*: <https://git.cs.dal.ca/ngaikwad/csci-4177-grp-16/-/tree/Ahmed?ref_type=heads>
* *Git Sofia branch url*: <https://git.cs.dal.ca/ngaikwad/csci-4177-grp-16/-/tree/Sofia?ref_type=heads>
* *Git Rahil branch url*: <https://git.cs.dal.ca/ngaikwad/csci-4177-grp-16/-/tree/rahil?ref_type=heads>
* *Git tutorial repo url*: <https://git.cs.dal.ca/keyush/csci4177_5709_tutorials>
* *Git assignment repo url*: <https://git.cs.dal.ca/keyush/csci4177_5709_assignments>
